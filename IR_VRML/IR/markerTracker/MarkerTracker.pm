...
<VisionLib2 Version="2.0">
  ...
  <ActionPipe category="Action" name="ActionPipe">
    ...
    <!--InputDeclarationAction category='Action' enabled='1' name='InputDeclaration' val='InputDeclarationAction'>
      <ActionConfig keys='ImageT__RGB_Frame:ImageLiveColour;'/>
    </InputDeclarationAction-->
    ...
    <!--HttpServerSink category='Action' enabled='1' name='HttpServerSink' val='HttpServerSink'>
      <Keys size='1'>
        <key type='' val='ImageLiveColour' what='output from stream'/>
      </Keys>
      <ActionConfig file='' port='8080'/>
    </HttpServerSink-->
    ...
    <ImageUndistortAction category="Action" name="Action">
      <Keys size="3">
        <key val="ImageLiveGrey"/>
        <key val="CameraIntrinsicParameters"/>
    ...
    <World key="TheWorld">
      <TrackedObject key="Koffer">
        ...
        <Marker BitSamples="2" MarkerSamples="6" NBPoints="4" key="Marker">
          ...
          <Points3D nb="4">
            <HomgPoint3d w="1" x="0" y="8.15" z="0"/>
            <HomgPoint3d w="1" x="5.4" y="8.15" z="0"/>
            <HomgPoint3d w="1" x="5.4" y="2.75" z="0"/>
            <HomgPoint3d w="1" x="0" y="2.75" z="0"/>
          </Points3D>
        </Marker>
       <Marker BitSamples="2" MarkerSamples="6" NBPoints="4" key="Marker_0">
        ...
        <Marker BitSamples="2" MarkerSamples="6" NBPoints="4" key="Marker_1">
          ...
          <Points3D nb="4">
            <HomgPoint3d w="1" x="0" y="-8.1" z="0"/>
            <HomgPoint3d w="1" x="5.4" y="-8.1" z="0"/>
            <HomgPoint3d w="1" x="5.4" y="-13.5" z="0"/>
            <HomgPoint3d w="1" x="0" y="-13.5" z="0"/>
          </Points3D>
        </Marker>
      </TrackedObject>
    </World>
