...
public class WebServerSample extends Thread {

    private WebServerSampleStarter message_to; //the starter class, needed for gui
    private int port; //port we are going to listen to

    public WebServerSample(int port, WebServerSampleStarter starter){
        this.message_to = starter;
        this.port = port;
        this.start();
    }
    ...
    public void run() {
        ...
        s("The simple http server v.1.0\nCoded as an example for OOAP course\n\n");
