...
public class SwingUsingBrowser extends JFrame implements HyperlinkListener,
        ActionListener
{

    public static void main(String[] args) {
        if (args.length == 0)
            new SwingUsingBrowser("http://www.java.com/");
        else
            new SwingUsingBrowser(args[0]);
    }
    ...
    public SwingUsingBrowser(String initialURL) {
